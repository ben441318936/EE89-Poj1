...
set_property PACKAGE_PIN W2 [get_ports {in5[0]}]			
	set_property IOSTANDARD LVCMOS33 [get_ports {in5[0]}]
set_property PACKAGE_PIN U1 [get_ports {in5[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {in5[1]}]
set_property PACKAGE_PIN T1 [get_ports {in5[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {in5[2]}]
set_property PACKAGE_PIN R2 [get_ports {in5[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {in5[3]}]
